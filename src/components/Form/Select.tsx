...
const SelectClasses = tv({
  slots: {
    ...
    select:
      "flex h-10 truncate w-full max-w-full items-center justify-between bg-zinc-900 text-white rounded-md p-2 outline-none placeholder:select-none placeholder:font-lato",
