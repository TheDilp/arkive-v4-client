...
export function ProjectCard({ id, title, image }: ProjectCardType) {
  ...
  return (
    <Link
      className="group relative col-span-1 flex h-[25rem] flex-col items-center justify-center overflow-hidden rounded bg-zinc-950 bg-cover bg-center bg-no-repeat shadow transition-all animate-in fade-in duration-500"
      to={`/projects/${id}`}>
